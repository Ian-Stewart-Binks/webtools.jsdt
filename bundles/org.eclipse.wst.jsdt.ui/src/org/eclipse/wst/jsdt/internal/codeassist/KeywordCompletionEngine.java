 ...
 */
public class KeywordCompletionEngine {
	...
	protected class ScopedCodeAssistVisitor extends HierarchicalASTVisitor {
		...
		private Stack<Scope> scopes = new Stack<KeywordCompletionEngine.Scope>();
	...
	public KeywordCompletionEngine(CompletionRequestor aRequestor, IJavaScriptProject aProject) {
