 ...
 *
 */
public class MemberCompletionProposalComputer implements IJavaCompletionProposalComputer {

	private MemberEngine engine;
	
	public MemberCompletionProposalComputer() {
		...
		engine = new MemberEngine(contextType);
	}
	...
	public List computeCompletionProposals(ContentAssistInvocationContext context, IProgressMonitor monitor) {
		System.out.println("Member completion proposal computer");
